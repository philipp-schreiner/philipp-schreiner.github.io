var data = [
    {
        ...
        "source": [{"tag": "ÖPG2022", "link": "https://oepg2022.unileoben.ac.at"},{"tag": "slides", "link": "resources/2022_09_28_OEPG.pdf"}]
    },
    {
        "category": "theses",
        "title": {"en": "A manifestly gauge-invariant description of the Minimal Supersymmetric Standard Model", "de": "Eine manifest eichinvariante Beschreibung des Minimal Supersymmetrischen Standardmodells"},
        "description": {"en": "[Master's Thesis <span style='font-weight: normal;'>(in progress)</span>] The Standard Model of Particle Physics (SM) is highly successful but has various drawbacks, one of which is that there is residual gauge-dependence left in the description of the weak-Higgs-sector. A more careful treatment leads to the so-called Fröhlich-Morchio-Strocci (FMS) mechanism which allows for a gauge-invariant description still in agreement with usual treatments. However, this agreement does <i>not</i> have to hold for theories beyond the SM. A natural question to ask is whether it holds in the minimal supersymmetric extension of the SM (MSSM).", "de": "[Masterarbeit (in Bearbeitung)] Das Standardmodell der Teilchenphysik (SM) ist eine überaus erfolgreiche Theorie. Dennoch hat sie ihre Schwächen, wie etwa die verbleibende Eichabhängigkeit in der üblichen Beschreibung des Higgs- und schwachen Wechselwirkungs-Sektor. Eine sorgfältigere Betrachtung führt zum sogenannten Fröhlich-Morchio-Strocci (FMS) Mechanismus, wodurch eine inhärent eichinvariante Beschreibung ermöglicht wird, die mit bisherigen Ergebnissen übereinstimmt. Diese Übereinstimmung ist jedoch nicht selbstverständlich und insbesondere für Theorien über das SM hinaus <i>nicht</i> garantiert! Daher kommt die Frage auf, ob es Unterschiede zwischen der herkömmlichen und der inhärent eichunabhängigen Beschreibung im minimal-supersymmetrischen Standardmodell (MSSM) gibt, oder nicht. "},
    ...
    },
    {
        ...
        "source": [{"tag": ".pdf", "link": "resources/2022_07_30_PionMass.pdf"},{"tag": "github", "link": "https://github.com/philipp-schreiner/StudentProject-PionMass"}]
    },
    {
        "category": "talks",
    ...
    },
    {
        ...
        "source": [{"tag": ".pdf", "link": "resources/ParticleCreation.pdf"},{"tag": "slides", "link": "resources/2022_02_23_ParticleCreationInExpandingUniverse.pdf"}]
    },
    {
        "category": "talks",
        ...
        "source": [{"tag": "slides", "link": "resources/2022_02_01_SUSY_intro.pdf"}]
    },
    {
        "category": "projects",
        ...
        "source": [{"tag": ".pdf", "link": "resources/BlackholeEventHorizon.pdf"}]
    },
    {
        "category": "projects",
        ...
        "source": [{"tag": ".pdf", "link": "resources/Gross_Neveu_Model.pdf"}, {"tag": "slides", "link": "resources/2021_07_Functional_renormalization_group_approach_for_interacting_Dirac_fermions.pdf"}]
    },
    {
        "category": "theses",
        ...
        "source": [{"tag": ".pdf", "link": "resources/2020_02_01_BachelorThesis.pdf"}, {"tag": "slides", "link": "resources/2019_11_28_GoldstoneDiagrams.pdf"}]
    },
    {
        "category": "projects",
